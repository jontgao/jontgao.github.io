...
export const projData: Proj[] = [
        ...
        content: [
            ...
            <H2Subsection
                ...
                subsectionContent={[
                    ...
                    <CaptionedImage src="/proj/foh/thumbnail.png" caption="A super sweet family we shared a filter with. This family had so many kids! The little girl in the stroller was disabled, and she also had the most adorable smile. I remember playing with little knick-knacks we had brought with the kids." />,
    ...
    },
    {
        ...
        content: [
            <TLDR cols={ [{title:"Skills",items:["Python", "PyTorch"]}, {title:"Timeline",items:["Spring 2025"]}, {title:"Team",items:["Jonathan Gao"]}] }/>,
            <h2>Coming soon!</h2>
            // <p>For my Natural Language Processing class, we explored methods for neural translation. </p>,
            // <p>In beam search decoding, we </p>,
            // <H2Subsection
            //     subsectionTitle="RNN-Based"
            //     subsectionContent={[
            //         <p></p>,
            //         <CaptionedImage src="/proj/neural-trans/" caption="" />,
            //     ]}
            // />,
        ]
    },
...
export const error404ProjData: Proj = {
    ...
    content: [
        <>
            <CaptionedImage src="/proj/pikachu.gif" caption="Pikachu attacking—and crashing into—a tree." />
