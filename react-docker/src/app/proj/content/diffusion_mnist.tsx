        ...
        <div className="proj-content-styles">
            ...
            <H2Subsection
                ...
                subsectionContent={[
                    ...
                    <p key="diffusion-mnist-1-2">Diffusion models operate by progressively adding noise to training images and learning to reverse this process, effectively "denoising" an image to recover or generate meaningful content. My implementation was based on the foundational work by <Link href="https://arxiv.org/abs/2006.11239">Ho et. al</Link>, which introduced a principled framework for training such models. We take a dataset of images (in this case, the <Link href="https://www.kaggle.com/datasets/hojjatk/mnist-dataset">MNIST dataset</Link> of handwritten numbers) and slowly add noise to the image. We train the diffusion model to "denoise" the noisy image to approximate the original image. After training, we input an image of complete noise to the model. Using the same process of denoising, the model effectively generates an image of a handwritten digit.</p>,
