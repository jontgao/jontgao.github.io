                ...
                subsectionContent={
                    <>
                        ...
                        <ul key="anl-4-1" className="list-disc">
                            ...
                            <li><b>Deployment:</b> I developed and integrated a <Link href="https://github.com/jontgao/waggle-plugin-solar-irradiance-forecasting">plug-in</Link> to deploy the model on edge devices, enabling real-time data collection and on-device inference.</li>
                        </ul>
